...
<div id="footer" class="clearfix" role="contentinfo">
	...
	<div id="footer-wrapper">
		...
		<div class="grid col-300 fit powered">
			<a href="<?php echo esc_url( 'https://github.com/vrkansagara/responsive' ); ?>" title="<?php esc_attr_e( 'Responsive Theme', 'responsive' ); ?>" rel="noindex, nofollow">Responsive Theme</a>
